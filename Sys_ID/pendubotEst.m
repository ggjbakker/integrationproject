function dxdt = pendubotEst(t,x,k1p,k1n,k2,tSys,cu)
% tSys being the fitted state space model for the torque 
% Set params
l1 = 0.1;
g = 9.806; 
...
x5 = [tSys(1) tSys(2)]*[x(5);x(6)]+tSys(5)*u;
x6 = [tSys(3) tSys(4)]*[x(5);x(6)]+tSys(6)*u;
tau = [tSys(7) tSys(8)]*[x(5);x(6)]; 
